 ...
 (el, x) => {
  ...
  d3.select('svg').style('width', '100%').style('height', '1100px');
  ...
  d3.select('#SankeyPlot').style('margin-top', '0px')
  d3.select('#SankeyPlot').style('margin-bottom', '300px')
  d3.select('#SankeyPlot').style('margin-left', '100px')
